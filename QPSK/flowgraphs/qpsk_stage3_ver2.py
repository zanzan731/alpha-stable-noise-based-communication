...
class qpsk_stage3_ver2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "qpsk_stage3_ver2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("qpsk_stage3_ver2")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "qpsk_stage3_ver2")
        ...
        self._time_offset_range = qtgui.Range(0, 1.001, 0.0001, 1.0005, 200)
        ...
        self.top_grid_layout.addWidget(self._time_offset_win, 1, 0, 1, 10)
        for r in range(1, 2):
        ...
        self.top_grid_layout.addWidget(self._freq_offset_win, 0, 10, 1, 10)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_c(
            200, #size
            samp_rate, #samp_rate
            'Synced Signal Time Domain', #name
            1, #number of inputs
            None # parent
        )
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_win, 12, 0, 10, 20)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_1_win, 2, 0, 10, 10)
        for r in range(2, 12):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 10):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_0_win, 2, 10, 10, 10)
        for r in range(2, 12):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(10, 20):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.connect((self.channels_channel_model_0, 0), (self.qtgui_freq_sink_x_1, 1))
        ...
        self.connect((self.fft_filter_xxx_0, 0), (self.qtgui_freq_sink_x_1, 0))
...
def main(top_block_cls=qpsk_stage3_ver2, options=None):
