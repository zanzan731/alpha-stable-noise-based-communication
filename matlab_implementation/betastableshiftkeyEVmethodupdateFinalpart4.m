...
betazero= -beta;
betaone=  beta;
sequencelengthafterpartition = [4 40 100 200];
...
figure;
semilogy(SNR,[BERL1 BERL2 BERL3 BERL4],'g*--');
...
ylabel('Bit Error Rate')
xlabel('SNR in dB')
title('BER vs SNR with alpha = 1.5 as function of L=[4 40 100 200] with AWGN noise')
