...
class alpha_stable_generator(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.source_file = source_file = r"C:\Users\ANEDCD~1\Desktop\3.letnik\Diploma\simulations\source.bin"
        self.samp_rate = samp_rate = 32000
        self.beta_map = beta_map = [-1.0, 1.0]
        ...
        self.epy_block_1 = epy_block_1.alpha_decoder(alpha_map=[1.2, 1.4, 1.6, 1.8], beta_map=beta_map, gama_map=[0.5, 1, 1.5, 2], samples_per_symbol=24, L=4, encode_alpha=False, encode_beta=True, encode_gama=False)
        self.epy_block_0 = epy_block_0.alpha_encoder(alpha_map=[1.2, 1.4, 1.6, 1.8], beta_map=beta_map, gama_map=[0.5, 1.0, 1.5, 2.0], samples_per_symbol=24, encode_alpha=False, encode_beta=True, encode_gama=False)
