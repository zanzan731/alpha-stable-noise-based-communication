...
class branje_signala(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "branje_signala")
...
def main(top_block_cls=branje_signala, options=None):
