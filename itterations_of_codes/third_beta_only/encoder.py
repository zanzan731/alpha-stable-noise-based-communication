...
class alpha_encoder(gr.basic_block):
    ...
    def __init__(self, alpha_map=[1.2, 1.4, 1.6, 1.8], beta_map=[-1.0, -0.3, 0.3, 1.0], gama_map=[0.5, 1.0, 1.5, 2.0], samples_per_symbol=1000, encode_alpha=True, encode_beta=True, encode_gama=False):
