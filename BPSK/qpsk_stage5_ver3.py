...
class qpsk_stage5_ver3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "qpsk_stage5_ver3")
        ...
        self.qpsk = qpsk = digital.constellation_rect([-0.5, +0.5], [0, 1],
        4, 2, 2, 1, 1).base()
        ...
        for c in range(0, 10):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._epsilon_range = qtgui.Range(0.0, 1.001, 0.0001, 1.0005, 200)
...
def main(top_block_cls=qpsk_stage5_ver3, options=None):
