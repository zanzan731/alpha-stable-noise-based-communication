...
class BPSK_signal_transmition(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "BPSK_signal_transmition", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("BPSK_signal_transmition")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "BPSK_signal_transmition")
...
def main(top_block_cls=BPSK_signal_transmition, options=None):
